...
import { HiArrowCircleRight, HiCursorClick } from "react-icons/hi";
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
              <div className="order-2 md:order-1">
                ...
                <p className="text-lg text-gray-600 mb-8">
                  Autenticación facial en una sola llamada. Autentica a tus
                  usuarios con un solo vistazo. Con tu API key obtienes inicio
                  de sesión sin contraseñas y una integración backend sin
                  fricción.
                </p>
                <div className="flex flex-col sm:flex-row space-y-4 sm:space-y-0 sm:space-x-4">
                  ...
                  >
                    Comenzar Ahora
                    <HiArrowCircleRight className="inline-block ml-2" />
                  </Link>
                  <a
                    href="/demo/index.html"
                    target="_blank"
                    className="px-6 py-3 bg-white text-indigo-600 font-medium rounded-md shadow-sm border border-indigo-200 hover:bg-cyan-200 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 transition duration-150"
                  >
                    Probar Demo
                    <HiCursorClick className="inline-block ml-2" />
                  </a>
                </div>
              </div>
        ...
        <footer className="bg-white border-t border-gray-200">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-12">
            ...
            <div className="mt-12 pt-8 border-t border-gray-200 flex flex-col md:flex-row justify-between items-center">
              <p className="text-sm text-gray-500">
                &copy; {new Date().getFullYear()} FaceAuth.
              </p>
              <div className="flex space-x-6 mt-4 md:mt-0">
                ...
                <a
                  href="https://github.com/jmvillanueva-dev/facial-auth-app.git"
                  target="_blank"
